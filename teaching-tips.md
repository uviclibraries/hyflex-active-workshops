...
9. **You See someone struggling**: If you see someone who is sharing their screen struggling what should you do?
  - If they are struggling with a common problem, it's likely that others who are not sharing their screens are experiencing the same problem. In this case don't call the person out but say, "I'm seeing a few people struggling with [state problem here]. Then talk through how to solve the problem without asking people to look at your screen. If you ask people to stop sharing their screens to look at yours it's very likely that most won't share their screen again after you've demonstrated how to solve the problem at hand.
